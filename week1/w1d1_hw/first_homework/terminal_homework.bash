...
# cd ~/galaxy_far_far_away/death_star && cp storm_trooper.txt ../tatooine

# Move `luke.txt` and `obi_wan.txt` to the `millenium_falcon`
# cd ~/galaxy_far_far_away/tatooine && mv luke.txt obi_wan.txt millenium_falcon
...
# mv millenium_falcon .. && cd .. && mv millenium_falcon death_star && cd death_star && mv princess_leia.txt millenium_falcon
...
# cd death_star && mv millenium_falcon ../yavin_4

# Make a directory in `yavin_4` called `x_wing`
# cd ../yavin_4 && mkdir x_wing

# Move `princess_leia.txt` to `yavin_4` and `luke.txt` to `x_wing`
# cd millenium_falcon && mv princess_leia.txt luke.txt .. && cd .. && mv luke.txt x_wing
